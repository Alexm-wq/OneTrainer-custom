...
class BaseTrainingTabView(ABC):
    ...
    def build(self, column_0, column_1, column_2, controller, ui_state):
        ...
        elif model_type.is_prx_pixel():
            self.__setup_prx_pixel_ui(column_0, column_1, column_2, controller, ui_state)
    ...
    def __setup_prx_pixel_ui(self, column_0, column_1, column_2, controller, ui_state):
        self.__create_base_frame(column_0, 0, controller, ui_state)
