...
@factory.register(BaseModelSetup, ModelType.PRX_PIXEL, TrainingMethod.LORA)
class PRXPixelLoRASetup(BasePRXPixelSetup):
    def __init__(
            self,
    ...
    def __setup_requires_grad(self, model: PRXPixelModel, config: TrainConfig):
    ...
    def setup_model(self, model: PRXPixelModel, config: TrainConfig):
    ...
    def setup_train_device(self, model: PRXPixelModel, config: TrainConfig):
