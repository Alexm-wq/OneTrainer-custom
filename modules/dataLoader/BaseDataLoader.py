...
class BaseDataLoader(
    ...
    def __init__(
        ...
        if is_validation:
            ...
            # Validation must remain an unbiased view of the configured dataset.
            # Adaptive DPO replacement is a training-only compute-allocation policy.
            config.rlhf_dpo_adaptive_dataset = False
